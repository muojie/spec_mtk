...
/*
asmlinkage long sys_sis_HID_stop(void);
asmlinkage long sys_sis_HID_start(void);
asmlinkage long sys_sis_HID_query(void);
asmlinkage long sys_sis_HID_IO( __u8 request, __u8 dir, __u16 value, __u16 index,void *data, __u16 size, int timeout);
*/
#endif
#endif
