/*
 * drivers/i2c/chips/SenseTek/stk_i2c_als220xgeneric.h
 *
 ...
 *	based on stk_i2c_als220xgeneric.c
 */
...
#ifdef CONFIG_STK_ALS_220X_INT_MODE
    struct work_struct work;
    int32_t irq;
	uint8_t enable_als_irq;
#else	
	uint8_t bThreadRunning;
#endif	//#ifdef CONFIG_STK_ALS_220X_INT_MODE
